...
pub const EnumerationOptions = enum(objc.NSUInteger) {
    EnumerationConcurrent = 1,
    EnumerationReverse = 2,
};
...
pub const QualityOfService = enum(objc.NSInteger) {
    QualityOfServiceUserInteractive = 33,
    QualityOfServiceUserInitiated = 25,
    QualityOfServiceUtility = 17,
    QualityOfServiceBackground = 9,
    QualityOfServiceDefault = -1,
};

pub const CollectionChangeType = enum(objc.NSInteger) {
    CollectionChangeInsert = 0,
    CollectionChangeRemove = 1,
};

pub const OrderedCollectionDifferenceCalculationOptions = enum(objc.NSUInteger) {
    OrderedCollectionDifferenceCalculationOmitInsertedObjects = 1,
    OrderedCollectionDifferenceCalculationOmitRemovedObjects = 2,
    OrderedCollectionDifferenceCalculationInferMoves = 4,
};

pub const BinarySearchingOptions = enum(objc.NSUInteger) {
    BinarySearchingFirstEqual = 256,
    BinarySearchingLastEqual = 512,
    BinarySearchingInsertionIndex = 1024,
};

pub const ItemProviderRepresentationVisibility = enum(objc.NSInteger) {
    ItemProviderRepresentationVisibilityAll = 0,
    ItemProviderRepresentationVisibilityTeam = 1,
    ItemProviderRepresentationVisibilityGroup = 2,
    ItemProviderRepresentationVisibilityOwnProcess = 3,
};

pub const ItemProviderFileOptions = enum(objc.NSInteger) {
    ItemProviderFileOptionOpenInPlace = 1,
};

pub const ItemProviderErrorCode = enum(objc.NSInteger) {
    ItemProviderUnknownError = -1,
    ItemProviderItemUnavailableError = -1000,
    ItemProviderUnexpectedValueClassError = -1100,
    ItemProviderUnavailableCoercionError = -1200,
};
...
pub const StringEnumerationOptions = enum(objc.NSUInteger) {
    ...
    StringEnumerationReverse = 256,
    StringEnumerationSubstringNotRequired = 512,
    StringEnumerationLocalized = 1024,
};
...
pub const CalendarOptions = enum(objc.NSUInteger) {
    CalendarWrapComponents = 1,
    CalendarMatchStrictly = 2,
    CalendarSearchBackwards = 4,
    CalendarMatchPreviousTimePreservingSmallerUnits = 256,
    CalendarMatchNextTimePreservingSmallerUnits = 512,
    CalendarMatchNextTime = 1024,
    CalendarMatchFirst = 4096,
    CalendarMatchLast = 8192,
};
...
pub const DecodingFailurePolicy = enum(objc.NSInteger) {
    DecodingFailurePolicyRaiseException = 0,
    DecodingFailurePolicySetErrorAndReturn = 1,
};
...
pub const DataSearchOptions = enum(objc.NSUInteger) {
    DataSearchBackwards = 1,
    DataSearchAnchored = 2,
};

pub const DataBase64EncodingOptions = enum(objc.NSUInteger) {
    DataBase64Encoding64CharacterLineLength = 1,
    DataBase64Encoding76CharacterLineLength = 2,
    DataBase64EncodingEndLineWithCarriageReturn = 16,
    DataBase64EncodingEndLineWithLineFeed = 32,
};

pub const DataBase64DecodingOptions = enum(objc.NSUInteger) {
    DataBase64DecodingIgnoreUnknownCharacters = 1,
};
...
pub const AttributedStringEnumerationOptions = enum(objc.NSUInteger) {
    AttributedStringEnumerationReverse = 2,
    AttributedStringEnumerationLongestEffectiveRangeNotRequired = 1048576,
};

pub const InlinePresentationIntent = enum(objc.NSUInteger) {
    InlinePresentationIntentEmphasized = 1,
    InlinePresentationIntentStronglyEmphasized = 2,
    InlinePresentationIntentCode = 4,
    InlinePresentationIntentStrikethrough = 32,
    InlinePresentationIntentSoftBreak = 64,
    InlinePresentationIntentLineBreak = 128,
    InlinePresentationIntentInlineHTML = 256,
    InlinePresentationIntentBlockHTML = 512,
};

pub const AttributedStringMarkdownParsingFailurePolicy = enum(objc.NSInteger) {
    AttributedStringMarkdownParsingFailureReturnError = 0,
    AttributedStringMarkdownParsingFailureReturnPartiallyParsedIfPossible = 1,
};

pub const AttributedStringMarkdownInterpretedSyntax = enum(objc.NSInteger) {
    AttributedStringMarkdownInterpretedSyntaxFull = 0,
    AttributedStringMarkdownInterpretedSyntaxInlineOnly = 1,
    AttributedStringMarkdownInterpretedSyntaxInlineOnlyPreservingWhitespace = 2,
};

pub const AttributedStringFormattingOptions = enum(objc.NSUInteger) {
    AttributedStringFormattingInsertArgumentAttributesWithoutMerging = 1,
    AttributedStringFormattingApplyReplacementIndexAttribute = 2,
};

pub const PresentationIntentKind = enum(objc.NSInteger) {
    PresentationIntentKindParagraph = 0,
    PresentationIntentKindHeader = 1,
    PresentationIntentKindOrderedList = 2,
    PresentationIntentKindUnorderedList = 3,
    PresentationIntentKindListItem = 4,
    PresentationIntentKindCodeBlock = 5,
    PresentationIntentKindBlockQuote = 6,
    PresentationIntentKindThematicBreak = 7,
    PresentationIntentKindTable = 8,
    PresentationIntentKindTableHeaderRow = 9,
    PresentationIntentKindTableRow = 10,
    PresentationIntentKindTableCell = 11,
};

pub const PresentationIntentTableColumnAlignment = enum(objc.NSInteger) {
    PresentationIntentTableColumnAlignmentLeft = 0,
    PresentationIntentTableColumnAlignmentCenter = 1,
    PresentationIntentTableColumnAlignmentRight = 2,
};

pub const FormattingContext = enum(objc.NSInteger) {
    FormattingContextUnknown = 0,
    FormattingContextDynamic = 1,
    FormattingContextStandalone = 2,
    FormattingContextListItem = 3,
    FormattingContextBeginningOfSentence = 4,
    FormattingContextMiddleOfSentence = 5,
};

pub const FormattingUnitStyle = enum(objc.NSInteger) {
    FormattingUnitStyleShort = 1,
    FormattingUnitStyleMedium = 2,
    FormattingUnitStyleLong = 3,
};

pub const DateFormatterStyle = enum(objc.NSUInteger) {
    DateFormatterNoStyle = 0,
    DateFormatterShortStyle = 1,
    DateFormatterMediumStyle = 2,
    DateFormatterLongStyle = 3,
    DateFormatterFullStyle = 4,
};

pub const DateFormatterBehavior = enum(objc.NSUInteger) {
    DateFormatterBehaviorDefault = 0,
    DateFormatterBehavior10_0 = 1000,
    DateFormatterBehavior10_4 = 1040,
};

pub const DateIntervalFormatterStyle = enum(objc.NSUInteger) {
    DateIntervalFormatterNoStyle = 0,
    DateIntervalFormatterShortStyle = 1,
    DateIntervalFormatterMediumStyle = 2,
    DateIntervalFormatterLongStyle = 3,
    DateIntervalFormatterFullStyle = 4,
};

pub const ISO8601DateFormatOptions = enum(objc.NSUInteger) {
    ISO8601DateFormatWithYear = 1,
    ISO8601DateFormatWithMonth = 2,
    ISO8601DateFormatWithWeekOfYear = 4,
    ISO8601DateFormatWithDay = 16,
    ISO8601DateFormatWithTime = 32,
    ISO8601DateFormatWithTimeZone = 64,
    ISO8601DateFormatWithSpaceBetweenDateAndTime = 128,
    ISO8601DateFormatWithDashSeparatorInDate = 256,
    ISO8601DateFormatWithColonSeparatorInTime = 512,
    ISO8601DateFormatWithColonSeparatorInTimeZone = 1024,
    ISO8601DateFormatWithFractionalSeconds = 2048,
    ISO8601DateFormatWithFullDate = 275,
    ISO8601DateFormatWithFullTime = 1632,
    ISO8601DateFormatWithInternetDateTime = 1907,
};

pub const MassFormatterUnit = enum(objc.NSInteger) {
    MassFormatterUnitGram = 11,
    MassFormatterUnitKilogram = 14,
    MassFormatterUnitOunce = 1537,
    MassFormatterUnitPound = 1538,
    MassFormatterUnitStone = 1539,
};

pub const LengthFormatterUnit = enum(objc.NSInteger) {
    LengthFormatterUnitMillimeter = 8,
    LengthFormatterUnitCentimeter = 9,
    LengthFormatterUnitMeter = 11,
    LengthFormatterUnitKilometer = 14,
    LengthFormatterUnitInch = 1281,
    LengthFormatterUnitFoot = 1282,
    LengthFormatterUnitYard = 1283,
    LengthFormatterUnitMile = 1284,
};

pub const EnergyFormatterUnit = enum(objc.NSInteger) {
    EnergyFormatterUnitJoule = 11,
    EnergyFormatterUnitKilojoule = 14,
    EnergyFormatterUnitCalorie = 1793,
    EnergyFormatterUnitKilocalorie = 1794,
};

pub const NumberFormatterBehavior = enum(objc.NSUInteger) {
    NumberFormatterBehaviorDefault = 0,
    NumberFormatterBehavior10_0 = 1000,
    NumberFormatterBehavior10_4 = 1040,
};

pub const NumberFormatterStyle = enum(objc.NSUInteger) {
    NumberFormatterNoStyle = 0,
    NumberFormatterDecimalStyle = 1,
    NumberFormatterCurrencyStyle = 2,
    NumberFormatterPercentStyle = 3,
    NumberFormatterScientificStyle = 4,
    NumberFormatterSpellOutStyle = 5,
    NumberFormatterOrdinalStyle = 6,
    NumberFormatterCurrencyISOCodeStyle = 8,
    NumberFormatterCurrencyPluralStyle = 9,
    NumberFormatterCurrencyAccountingStyle = 10,
};

pub const NumberFormatterPadPosition = enum(objc.NSUInteger) {
    NumberFormatterPadBeforePrefix = 0,
    NumberFormatterPadAfterPrefix = 1,
    NumberFormatterPadBeforeSuffix = 2,
    NumberFormatterPadAfterSuffix = 3,
};

pub const NumberFormatterRoundingMode = enum(objc.NSUInteger) {
    NumberFormatterRoundCeiling = 0,
    NumberFormatterRoundFloor = 1,
    NumberFormatterRoundDown = 2,
    NumberFormatterRoundUp = 3,
    NumberFormatterRoundHalfEven = 4,
    NumberFormatterRoundHalfDown = 5,
    NumberFormatterRoundHalfUp = 6,
};

pub const LocaleLanguageDirection = enum(objc.NSUInteger) {
    LocaleLanguageDirectionUnknown = 0,
    LocaleLanguageDirectionLeftToRight = 1,
    LocaleLanguageDirectionRightToLeft = 2,
    LocaleLanguageDirectionTopToBottom = 3,
    LocaleLanguageDirectionBottomToTop = 4,
};

pub const MeasurementFormatterUnitOptions = enum(objc.NSUInteger) {
    MeasurementFormatterUnitOptionsProvidedUnit = 1,
    MeasurementFormatterUnitOptionsNaturalScale = 2,
    MeasurementFormatterUnitOptionsTemperatureWithoutUnit = 4,
};

pub const PersonNameComponentsFormatterStyle = enum(objc.NSInteger) {
    PersonNameComponentsFormatterStyleDefault = 0,
    PersonNameComponentsFormatterStyleShort = 1,
    PersonNameComponentsFormatterStyleMedium = 2,
    PersonNameComponentsFormatterStyleLong = 3,
    PersonNameComponentsFormatterStyleAbbreviated = 4,
};

pub const PersonNameComponentsFormatterOptions = enum(objc.NSUInteger) {
    PersonNameComponentsFormatterPhonetic = 2,
};

pub const RelativeDateTimeFormatterStyle = enum(objc.NSInteger) {
    RelativeDateTimeFormatterStyleNumeric = 0,
    RelativeDateTimeFormatterStyleNamed = 1,
};

pub const RelativeDateTimeFormatterUnitsStyle = enum(objc.NSInteger) {
    RelativeDateTimeFormatterUnitsStyleFull = 0,
    RelativeDateTimeFormatterUnitsStyleSpellOut = 1,
    RelativeDateTimeFormatterUnitsStyleShort = 2,
    RelativeDateTimeFormatterUnitsStyleAbbreviated = 3,
};
...
pub const CalculationError = enum(objc.NSUInteger) {
    CalculationNoError = 0,
    CalculationLossOfPrecision = 1,
    CalculationUnderflow = 2,
    CalculationOverflow = 3,
    CalculationDivideByZero = 4,
};
...
pub const URLHandleStatus = enum(objc.NSUInteger) {
    URLHandleNotLoaded = 0,
    URLHandleLoadSucceeded = 1,
    URLHandleLoadInProgress = 2,
    URLHandleLoadFailed = 3,
};

pub const URLBookmarkCreationOptions = enum(objc.NSUInteger) {
    URLBookmarkCreationPreferFileIDResolution = 256,
    URLBookmarkCreationMinimalBookmark = 512,
    URLBookmarkCreationSuitableForBookmarkFile = 1024,
    URLBookmarkCreationWithSecurityScope = 2048,
    URLBookmarkCreationSecurityScopeAllowOnlyReadAccess = 4096,
    URLBookmarkCreationWithoutImplicitSecurityScope = 536870912,
};

pub const URLBookmarkResolutionOptions = enum(objc.NSUInteger) {
    URLBookmarkResolutionWithoutUI = 256,
    URLBookmarkResolutionWithoutMounting = 512,
...
pub const VolumeEnumerationOptions = enum(objc.NSUInteger) {
    VolumeEnumerationSkipHiddenVolumes = 2,
    VolumeEnumerationProduceFileReferenceURLs = 4,
};

pub const DirectoryEnumerationOptions = enum(objc.NSUInteger) {
    DirectoryEnumerationSkipsSubdirectoryDescendants = 1,
    DirectoryEnumerationSkipsPackageDescendants = 2,
    DirectoryEnumerationSkipsHiddenFiles = 4,
    DirectoryEnumerationIncludesDirectoriesPostOrder = 8,
    DirectoryEnumerationProducesRelativePathURLs = 16,
};

pub const FileManagerItemReplacementOptions = enum(objc.NSUInteger) {
    FileManagerItemReplacementUsingNewMetadataOnly = 1,
    FileManagerItemReplacementWithoutDeletingBackupItem = 2,
};

pub const URLRelationship = enum(objc.NSInteger) {
    URLRelationshipContains = 0,
    URLRelationshipSame = 1,
    URLRelationshipOther = 2,
};

pub const FileManagerUnmountOptions = enum(objc.NSUInteger) {
    FileManagerUnmountAllPartitionsAndEjectDisk = 1,
    FileManagerUnmountWithoutUI = 2,
};

pub const PointerFunctionsOptions = enum(objc.NSUInteger) {
    PointerFunctionsStrongMemory = 0,
    PointerFunctionsZeroingWeakMemory = 1,
    PointerFunctionsOpaqueMemory = 2,
    PointerFunctionsMallocMemory = 3,
    PointerFunctionsMachVirtualMemory = 4,
    PointerFunctionsWeakMemory = 5,
    PointerFunctionsObjectPersonality = 0,
    PointerFunctionsOpaquePersonality = 256,
    PointerFunctionsObjectPointerPersonality = 512,
    PointerFunctionsCStringPersonality = 768,
    PointerFunctionsStructPersonality = 1024,
    PointerFunctionsIntegerPersonality = 1280,
    PointerFunctionsCopyIn = 65536,
};
...
pub const JSONReadingOptions = enum(objc.NSUInteger) {
    JSONReadingMutableContainers = 1,
    JSONReadingMutableLeaves = 2,
    JSONReadingFragmentsAllowed = 4,
    JSONReadingJSON5Allowed = 8,
    JSONReadingTopLevelDictionaryAssumed = 16,
    JSONReadingAllowFragments = 4,
};

pub const JSONWritingOptions = enum(objc.NSUInteger) {
    JSONWritingPrettyPrinted = 1,
    JSONWritingSortedKeys = 2,
    JSONWritingFragmentsAllowed = 4,
    JSONWritingWithoutEscapingSlashes = 8,
};

pub const KeyValueObservingOptions = enum(objc.NSUInteger) {
    KeyValueObservingOptionNew = 1,
    KeyValueObservingOptionOld = 2,
    KeyValueObservingOptionInitial = 4,
    KeyValueObservingOptionPrior = 8,
};
...
pub const PropertyListMutabilityOptions = enum(objc.NSUInteger) {
    PropertyListImmutable = 0,
    PropertyListMutableContainers = 1,
    PropertyListMutableContainersAndLeaves = 2,
};

pub const PropertyListFormat = enum(objc.NSUInteger) {
    PropertyListOpenStepFormat = 1,
    PropertyListXMLFormat_v1_0 = 100,
    PropertyListBinaryFormat_v1_0 = 200,
};
...
pub const GrammaticalGender = enum(objc.NSInteger) {
    GrammaticalGenderNotSet = 0,
    GrammaticalGenderFeminine = 1,
    GrammaticalGenderMasculine = 2,
    GrammaticalGenderNeuter = 3,
};

pub const GrammaticalPartOfSpeech = enum(objc.NSInteger) {
    GrammaticalPartOfSpeechNotSet = 0,
    GrammaticalPartOfSpeechDeterminer = 1,
    GrammaticalPartOfSpeechPronoun = 2,
    GrammaticalPartOfSpeechLetter = 3,
    GrammaticalPartOfSpeechAdverb = 4,
    GrammaticalPartOfSpeechParticle = 5,
    GrammaticalPartOfSpeechAdjective = 6,
    GrammaticalPartOfSpeechAdposition = 7,
    GrammaticalPartOfSpeechVerb = 8,
    GrammaticalPartOfSpeechNoun = 9,
    GrammaticalPartOfSpeechConjunction = 10,
    GrammaticalPartOfSpeechNumeral = 11,
    GrammaticalPartOfSpeechInterjection = 12,
    GrammaticalPartOfSpeechPreposition = 13,
    GrammaticalPartOfSpeechAbbreviation = 14,
};

pub const GrammaticalNumber = enum(objc.NSInteger) {
    GrammaticalNumberNotSet = 0,
    GrammaticalNumberSingular = 1,
    GrammaticalNumberZero = 2,
    GrammaticalNumberPlural = 3,
    GrammaticalNumberPluralTwo = 4,
    GrammaticalNumberPluralFew = 5,
    GrammaticalNumberPluralMany = 6,
};

pub const GrammaticalCase = enum(objc.NSInteger) {
    GrammaticalCaseNotSet = 0,
    GrammaticalCaseNominative = 1,
    GrammaticalCaseAccusative = 2,
    GrammaticalCaseDative = 3,
    GrammaticalCaseGenitive = 4,
    GrammaticalCasePrepositional = 5,
    GrammaticalCaseAblative = 6,
    GrammaticalCaseAdessive = 7,
    GrammaticalCaseAllative = 8,
    GrammaticalCaseElative = 9,
    GrammaticalCaseIllative = 10,
    GrammaticalCaseEssive = 11,
    GrammaticalCaseInessive = 12,
    GrammaticalCaseLocative = 13,
    GrammaticalCaseTranslative = 14,
};

pub const GrammaticalPronounType = enum(objc.NSInteger) {
    GrammaticalPronounTypeNotSet = 0,
    GrammaticalPronounTypePersonal = 1,
    GrammaticalPronounTypeReflexive = 2,
    GrammaticalPronounTypePossessive = 3,
};

pub const GrammaticalPerson = enum(objc.NSInteger) {
    GrammaticalPersonNotSet = 0,
    GrammaticalPersonFirst = 1,
    GrammaticalPersonSecond = 2,
    GrammaticalPersonThird = 3,
};

pub const GrammaticalDetermination = enum(objc.NSInteger) {
    GrammaticalDeterminationNotSet = 0,
    GrammaticalDeterminationIndependent = 1,
    GrammaticalDeterminationDependent = 2,
};

pub const GrammaticalDefiniteness = enum(objc.NSInteger) {
    GrammaticalDefinitenessNotSet = 0,
    GrammaticalDefinitenessIndefinite = 1,
    GrammaticalDefinitenessDefinite = 2,
};
...
pub const NotificationCoalescing = enum(objc.NSUInteger) {
    NotificationNoCoalescing = 0,
    NotificationCoalescingOnName = 1,
    NotificationCoalescingOnSender = 2,
};

pub const OperationQueuePriority = enum(objc.NSInteger) {
    OperationQueuePriorityVeryLow = -8,
    OperationQueuePriorityLow = -4,
    OperationQueuePriorityNormal = 0,
    OperationQueuePriorityHigh = 4,
    OperationQueuePriorityVeryHigh = 8,
};

pub const MachPortOptions = enum(objc.NSUInteger) {
    MachPortDeallocateNone = 0,
    MachPortDeallocateSendRight = 1,
    MachPortDeallocateReceiveRight = 2,
};
...
pub const ActivityOptions = enum(objc.uint64_t) {
    ...
    ActivityAnimationTrackingEnabled = 35184372088832,
    ActivityTrackingEnabled = 70368744177664,
    ...
    ActivityUserInteractive = 1095233437695,
};
...
pub const TextCheckingType = enum(objc.uint64_t) {
    TextCheckingTypeOrthography = 1,
    TextCheckingTypeSpelling = 2,
    TextCheckingTypeGrammar = 4,
    TextCheckingTypeDate = 8,
    TextCheckingTypeAddress = 16,
    TextCheckingTypeLink = 32,
    TextCheckingTypeQuote = 64,
    TextCheckingTypeDash = 128,
    TextCheckingTypeReplacement = 256,
    TextCheckingTypeCorrection = 512,
    TextCheckingTypeRegularExpression = 1024,
    TextCheckingTypePhoneNumber = 2048,
    TextCheckingTypeTransitInformation = 4096,
};
...
pub const StreamStatus = enum(objc.NSUInteger) {
    StreamStatusNotOpen = 0,
    StreamStatusOpening = 1,
    StreamStatusOpen = 2,
    StreamStatusReading = 3,
    StreamStatusWriting = 4,
    StreamStatusAtEnd = 5,
    StreamStatusClosed = 6,
    StreamStatusError = 7,
};

pub const StreamEvent = enum(objc.NSUInteger) {
    StreamEventNone = 0,
    StreamEventOpenCompleted = 1,
    StreamEventHasBytesAvailable = 2,
    StreamEventHasSpaceAvailable = 4,
    StreamEventErrorOccurred = 8,
    StreamEventEndEncountered = 16,
};

pub const TimeZoneNameStyle = enum(objc.NSInteger) {
    TimeZoneNameStyleStandard = 0,
    TimeZoneNameStyleShortStandard = 1,
    TimeZoneNameStyleDaylightSaving = 2,
    TimeZoneNameStyleShortDaylightSaving = 3,
    TimeZoneNameStyleGeneric = 4,
    TimeZoneNameStyleShortGeneric = 5,
};

pub const URLCacheStoragePolicy = enum(objc.NSUInteger) {
    URLCacheStorageAllowed = 0,
    URLCacheStorageAllowedInMemoryOnly = 1,
    URLCacheStorageNotAllowed = 2,
};
...
pub const URLCredentialPersistence = enum(objc.NSUInteger) {
    URLCredentialPersistenceNone = 0,
    URLCredentialPersistenceForSession = 1,
    URLCredentialPersistencePermanent = 2,
    URLCredentialPersistenceSynchronizable = 3,
};
...
pub const URLErrorNetworkUnavailableReason = enum(objc.NSInteger) {
    URLErrorNetworkUnavailableReasonCellular = 0,
    URLErrorNetworkUnavailableReasonExpensive = 1,
    URLErrorNetworkUnavailableReasonConstrained = 2,
};
...
pub const URLRequestCachePolicy = enum(objc.NSUInteger) {
    URLRequestUseProtocolCachePolicy = 0,
    URLRequestReloadIgnoringLocalCacheData = 1,
    URLRequestReloadIgnoringLocalAndRemoteCacheData = 4,
    URLRequestReloadIgnoringCacheData = 1,
    URLRequestReturnCacheDataElseLoad = 2,
    URLRequestReturnCacheDataDontLoad = 3,
    URLRequestReloadRevalidatingCacheData = 5,
};

pub const URLRequestNetworkServiceType = enum(objc.NSUInteger) {
    URLNetworkServiceTypeDefault = 0,
    URLNetworkServiceTypeVoIP = 1,
    URLNetworkServiceTypeVideo = 2,
    URLNetworkServiceTypeBackground = 3,
    URLNetworkServiceTypeVoice = 4,
    URLNetworkServiceTypeResponsiveData = 6,
    URLNetworkServiceTypeAVStreaming = 8,
    URLNetworkServiceTypeResponsiveAV = 9,
    URLNetworkServiceTypeCallSignaling = 11,
};

pub const URLRequestAttribution = enum(objc.NSUInteger) {
    URLRequestAttributionDeveloper = 0,
    URLRequestAttributionUser = 1,
};

pub const XMLParserExternalEntityResolvingPolicy = enum(objc.NSUInteger) {
    XMLParserResolveExternalEntitiesNever = 0,
    XMLParserResolveExternalEntitiesNoNetwork = 1,
    XMLParserResolveExternalEntitiesSameOriginOnly = 2,
    XMLParserResolveExternalEntitiesAlways = 3,
};

pub const XMLParserError = enum(objc.NSInteger) {
    XMLParserInternalError = 1,
    XMLParserOutOfMemoryError = 2,
    XMLParserDocumentStartError = 3,
    XMLParserEmptyDocumentError = 4,
    XMLParserPrematureDocumentEndError = 5,
    XMLParserInvalidHexCharacterRefError = 6,
    XMLParserInvalidDecimalCharacterRefError = 7,
    XMLParserInvalidCharacterRefError = 8,
    XMLParserInvalidCharacterError = 9,
    XMLParserCharacterRefAtEOFError = 10,
    XMLParserCharacterRefInPrologError = 11,
    XMLParserCharacterRefInEpilogError = 12,
    XMLParserCharacterRefInDTDError = 13,
    XMLParserEntityRefAtEOFError = 14,
    XMLParserEntityRefInPrologError = 15,
    XMLParserEntityRefInEpilogError = 16,
    XMLParserEntityRefInDTDError = 17,
    XMLParserParsedEntityRefAtEOFError = 18,
    XMLParserParsedEntityRefInPrologError = 19,
    XMLParserParsedEntityRefInEpilogError = 20,
    XMLParserParsedEntityRefInInternalSubsetError = 21,
    XMLParserEntityReferenceWithoutNameError = 22,
    XMLParserEntityReferenceMissingSemiError = 23,
    XMLParserParsedEntityRefNoNameError = 24,
    XMLParserParsedEntityRefMissingSemiError = 25,
    XMLParserUndeclaredEntityError = 26,
    XMLParserUnparsedEntityError = 28,
    XMLParserEntityIsExternalError = 29,
    XMLParserEntityIsParameterError = 30,
    XMLParserUnknownEncodingError = 31,
    XMLParserEncodingNotSupportedError = 32,
    XMLParserStringNotStartedError = 33,
    XMLParserStringNotClosedError = 34,
    XMLParserNamespaceDeclarationError = 35,
    XMLParserEntityNotStartedError = 36,
    XMLParserEntityNotFinishedError = 37,
    XMLParserLessThanSymbolInAttributeError = 38,
    XMLParserAttributeNotStartedError = 39,
    XMLParserAttributeNotFinishedError = 40,
    XMLParserAttributeHasNoValueError = 41,
    XMLParserAttributeRedefinedError = 42,
    XMLParserLiteralNotStartedError = 43,
    XMLParserLiteralNotFinishedError = 44,
    XMLParserCommentNotFinishedError = 45,
    XMLParserProcessingInstructionNotStartedError = 46,
    XMLParserProcessingInstructionNotFinishedError = 47,
    XMLParserNotationNotStartedError = 48,
    XMLParserNotationNotFinishedError = 49,
    XMLParserAttributeListNotStartedError = 50,
    XMLParserAttributeListNotFinishedError = 51,
    XMLParserMixedContentDeclNotStartedError = 52,
    XMLParserMixedContentDeclNotFinishedError = 53,
    XMLParserElementContentDeclNotStartedError = 54,
    XMLParserElementContentDeclNotFinishedError = 55,
    XMLParserXMLDeclNotStartedError = 56,
    XMLParserXMLDeclNotFinishedError = 57,
    XMLParserConditionalSectionNotStartedError = 58,
    XMLParserConditionalSectionNotFinishedError = 59,
    XMLParserExternalSubsetNotFinishedError = 60,
    XMLParserDOCTYPEDeclNotFinishedError = 61,
    XMLParserMisplacedCDATAEndStringError = 62,
    XMLParserCDATANotFinishedError = 63,
    XMLParserMisplacedXMLDeclarationError = 64,
    XMLParserSpaceRequiredError = 65,
    XMLParserSeparatorRequiredError = 66,
    XMLParserNMTOKENRequiredError = 67,
    XMLParserNAMERequiredError = 68,
    XMLParserPCDATARequiredError = 69,
    XMLParserURIRequiredError = 70,
    XMLParserPublicIdentifierRequiredError = 71,
    XMLParserLTRequiredError = 72,
    XMLParserGTRequiredError = 73,
    XMLParserLTSlashRequiredError = 74,
    XMLParserEqualExpectedError = 75,
    XMLParserTagNameMismatchError = 76,
    XMLParserUnfinishedTagError = 77,
    XMLParserStandaloneValueError = 78,
    XMLParserInvalidEncodingNameError = 79,
    XMLParserCommentContainsDoubleHyphenError = 80,
    XMLParserInvalidEncodingError = 81,
    XMLParserExternalStandaloneEntityError = 82,
    XMLParserInvalidConditionalSectionError = 83,
    XMLParserEntityValueRequiredError = 84,
    XMLParserNotWellBalancedError = 85,
    XMLParserExtraContentError = 86,
    XMLParserInvalidCharacterInEntityError = 87,
    XMLParserParsedEntityRefInInternalError = 88,
    XMLParserEntityRefLoopError = 89,
    XMLParserEntityBoundaryError = 90,
    XMLParserInvalidURIError = 91,
    XMLParserURIFragmentError = 92,
    XMLParserNoDTDError = 94,
    XMLParserDelegateAbortedParseError = 512,
};

pub const XPCConnectionOptions = enum(objc.NSUInteger) {
    XPCConnectionPrivileged = 4096,
};

pub const ByteCountFormatterUnits = enum(objc.NSUInteger) {
    ByteCountFormatterUseDefault = 0,
    ByteCountFormatterUseBytes = 1,
    ByteCountFormatterUseKB = 2,
    ByteCountFormatterUseMB = 4,
    ByteCountFormatterUseGB = 8,
    ByteCountFormatterUseTB = 16,
    ByteCountFormatterUsePB = 32,
    ByteCountFormatterUseEB = 64,
    ByteCountFormatterUseZB = 128,
    ByteCountFormatterUseYBOrHigher = 65280,
    ByteCountFormatterUseAll = 65535,
};

pub const ByteCountFormatterCountStyle = enum(objc.NSInteger) {
    ByteCountFormatterCountStyleFile = 0,
    ByteCountFormatterCountStyleMemory = 1,
    ByteCountFormatterCountStyleDecimal = 2,
    ByteCountFormatterCountStyleBinary = 3,
};
...
pub const DateComponentsFormatterUnitsStyle = enum(objc.NSInteger) {
    DateComponentsFormatterUnitsStylePositional = 0,
    DateComponentsFormatterUnitsStyleAbbreviated = 1,
    DateComponentsFormatterUnitsStyleShort = 2,
    DateComponentsFormatterUnitsStyleFull = 3,
    DateComponentsFormatterUnitsStyleSpellOut = 4,
    DateComponentsFormatterUnitsStyleBrief = 5,
};

pub const DateComponentsFormatterZeroFormattingBehavior = enum(objc.NSUInteger) {
    DateComponentsFormatterZeroFormattingBehaviorNone = 0,
    DateComponentsFormatterZeroFormattingBehaviorDefault = 1,
    DateComponentsFormatterZeroFormattingBehaviorDropLeading = 2,
    DateComponentsFormatterZeroFormattingBehaviorDropMiddle = 4,
    DateComponentsFormatterZeroFormattingBehaviorDropTrailing = 8,
    DateComponentsFormatterZeroFormattingBehaviorDropAll = 14,
    DateComponentsFormatterZeroFormattingBehaviorPad = 65536,
};
...
pub const FileCoordinatorReadingOptions = enum(objc.NSUInteger) {
    FileCoordinatorReadingWithoutChanges = 1,
    FileCoordinatorReadingResolvesSymbolicLink = 2,
    FileCoordinatorReadingImmediatelyAvailableMetadataOnly = 4,
    FileCoordinatorReadingForUploading = 8,
};

pub const FileCoordinatorWritingOptions = enum(objc.NSUInteger) {
    FileCoordinatorWritingForDeleting = 1,
    FileCoordinatorWritingForMoving = 2,
    FileCoordinatorWritingForMerging = 4,
    FileCoordinatorWritingForReplacing = 8,
    FileCoordinatorWritingContentIndependentMetadataOnly = 16,
};

pub const FileVersionAddingOptions = enum(objc.NSUInteger) {
    FileVersionAddingByMoving = 1,
};

pub const FileVersionReplacingOptions = enum(objc.NSUInteger) {
    FileVersionReplacingByMoving = 1,
};

pub const FileWrapperReadingOptions = enum(objc.NSUInteger) {
    FileWrapperReadingImmediate = 1,
    FileWrapperReadingWithoutMapping = 2,
};

pub const FileWrapperWritingOptions = enum(objc.NSUInteger) {
    FileWrapperWritingAtomic = 1,
    FileWrapperWritingWithNameUpdating = 2,
};

pub const LinguisticTaggerUnit = enum(objc.NSInteger) {
    LinguisticTaggerUnitWord = 0,
    LinguisticTaggerUnitSentence = 1,
    LinguisticTaggerUnitParagraph = 2,
    LinguisticTaggerUnitDocument = 3,
};

pub const LinguisticTaggerOptions = enum(objc.NSUInteger) {
    LinguisticTaggerOmitWords = 1,
    LinguisticTaggerOmitPunctuation = 2,
    LinguisticTaggerOmitWhitespace = 4,
    LinguisticTaggerOmitOther = 8,
    LinguisticTaggerJoinNames = 16,
};

pub const NetServicesError = enum(objc.NSInteger) {
    NetServicesUnknownError = -72000,
    NetServicesCollisionError = -72001,
    NetServicesNotFoundError = -72002,
    NetServicesActivityInProgress = -72003,
    NetServicesBadArgumentError = -72004,
    NetServicesCancelledError = -72005,
    NetServicesInvalidError = -72006,
    NetServicesTimeoutError = -72007,
    NetServicesMissingRequiredConfigurationError = -72008,
};

pub const NetServiceOptions = enum(objc.NSUInteger) {
    NetServiceNoAutoRename = 1,
    NetServiceListenForConnections = 2,
};

pub const URLSessionTaskState = enum(objc.NSInteger) {
    URLSessionTaskStateRunning = 0,
    URLSessionTaskStateSuspended = 1,
    URLSessionTaskStateCanceling = 2,
    URLSessionTaskStateCompleted = 3,
};

pub const URLSessionWebSocketMessageType = enum(objc.NSInteger) {
    URLSessionWebSocketMessageTypeData = 0,
    URLSessionWebSocketMessageTypeString = 1,
};

pub const URLSessionWebSocketCloseCode = enum(objc.NSInteger) {
    URLSessionWebSocketCloseCodeInvalid = 0,
    URLSessionWebSocketCloseCodeNormalClosure = 1000,
    URLSessionWebSocketCloseCodeGoingAway = 1001,
    URLSessionWebSocketCloseCodeProtocolError = 1002,
    URLSessionWebSocketCloseCodeUnsupportedData = 1003,
    URLSessionWebSocketCloseCodeNoStatusReceived = 1005,
    URLSessionWebSocketCloseCodeAbnormalClosure = 1006,
    URLSessionWebSocketCloseCodeInvalidFramePayloadData = 1007,
    URLSessionWebSocketCloseCodePolicyViolation = 1008,
    URLSessionWebSocketCloseCodeMessageTooBig = 1009,
    URLSessionWebSocketCloseCodeMandatoryExtensionMissing = 1010,
    URLSessionWebSocketCloseCodeInternalServerError = 1011,
    URLSessionWebSocketCloseCodeTLSHandshakeFailure = 1015,
};

pub const URLSessionMultipathServiceType = enum(objc.NSInteger) {
    URLSessionMultipathServiceTypeNone = 0,
    URLSessionMultipathServiceTypeHandover = 1,
    URLSessionMultipathServiceTypeInteractive = 2,
    URLSessionMultipathServiceTypeAggregate = 3,
};
...
pub const URLSessionTaskMetricsResourceFetchType = enum(objc.NSInteger) {
    URLSessionTaskMetricsResourceFetchTypeUnknown = 0,
    URLSessionTaskMetricsResourceFetchTypeNetworkLoad = 1,
    URLSessionTaskMetricsResourceFetchTypeServerPush = 2,
    URLSessionTaskMetricsResourceFetchTypeLocalCache = 3,
};

pub const URLSessionTaskMetricsDomainResolutionProtocol = enum(objc.NSInteger) {
    URLSessionTaskMetricsDomainResolutionProtocolUnknown = 0,
    URLSessionTaskMetricsDomainResolutionProtocolUDP = 1,
    URLSessionTaskMetricsDomainResolutionProtocolTCP = 2,
    URLSessionTaskMetricsDomainResolutionProtocolTLS = 3,
    URLSessionTaskMetricsDomainResolutionProtocolHTTPS = 4,
};
...
pub const DistributedNotificationOptions = enum(objc.NSUInteger) {
    DistributedNotificationDeliverImmediately = 1,
    DistributedNotificationPostToAllSessions = 2,
};

pub const TaskTerminationReason = enum(objc.NSInteger) {
    TaskTerminationReasonExit = 1,
    TaskTerminationReasonUncaughtSignal = 2,
};

pub const XMLNodeOptions = enum(objc.NSUInteger) {
    XMLNodeOptionsNone = 0,
    XMLNodeIsCDATA = 1,
    XMLNodeExpandEmptyElement = 2,
    XMLNodeCompactEmptyElement = 4,
    XMLNodeUseSingleQuotes = 8,
    XMLNodeUseDoubleQuotes = 16,
    XMLNodeNeverEscapeContents = 32,
    XMLDocumentTidyHTML = 512,
    XMLDocumentTidyXML = 1024,
    XMLDocumentValidate = 8192,
    XMLNodeLoadExternalEntitiesAlways = 16384,
    XMLNodeLoadExternalEntitiesSameOriginOnly = 32768,
    XMLNodeLoadExternalEntitiesNever = 524288,
    XMLDocumentXInclude = 65536,
    XMLNodePrettyPrint = 131072,
    XMLDocumentIncludeContentTypeDeclaration = 262144,
    XMLNodePreserveNamespaceOrder = 1048576,
    XMLNodePreserveAttributeOrder = 2097152,
    XMLNodePreserveEntities = 4194304,
    XMLNodePreservePrefixes = 8388608,
    XMLNodePreserveCDATA = 16777216,
    XMLNodePreserveWhitespace = 33554432,
    XMLNodePreserveDTD = 67108864,
    XMLNodePreserveCharacterReferences = 134217728,
    XMLNodePromoteSignificantWhitespace = 268435456,
    XMLNodePreserveEmptyElements = 6,
    XMLNodePreserveQuotes = 24,
    XMLNodePreserveAll = 4293918750,
};
...
pub const XMLNodeKind = enum(objc.NSUInteger) {
    ...
    XMLAttributeKind = 3,
    XMLNamespaceKind = 4,
    XMLProcessingInstructionKind = 5,
    XMLCommentKind = 6,
    XMLTextKind = 7,
    XMLDTDKind = 8,
    XMLEntityDeclarationKind = 9,
    XMLAttributeDeclarationKind = 10,
    XMLElementDeclarationKind = 11,
    XMLNotationDeclarationKind = 12,
};

pub const XMLDTDNodeKind = enum(objc.NSUInteger) {
    XMLEntityGeneralKind = 1,
    XMLEntityParsedKind = 2,
    XMLEntityUnparsedKind = 3,
    XMLEntityParameterKind = 4,
    XMLEntityPredefined = 5,
    XMLAttributeCDATAKind = 6,
    XMLAttributeIDKind = 7,
    XMLAttributeIDRefKind = 8,
    XMLAttributeIDRefsKind = 9,
    XMLAttributeEntityKind = 10,
    XMLAttributeEntitiesKind = 11,
    XMLAttributeNMTokenKind = 12,
    XMLAttributeNMTokensKind = 13,
    XMLAttributeEnumerationKind = 14,
    XMLAttributeNotationKind = 15,
    XMLElementDeclarationUndefinedKind = 16,
    XMLElementDeclarationEmptyKind = 17,
    XMLElementDeclarationAnyKind = 18,
    XMLElementDeclarationMixedKind = 19,
    XMLElementDeclarationElementKind = 20,
};

pub const XMLDocumentContentKind = enum(objc.NSUInteger) {
    XMLDocumentXMLKind = 0,
    XMLDocumentXHTMLKind = 1,
    XMLDocumentHTMLKind = 2,
    XMLDocumentTextKind = 3,
};

pub const AppleEventSendOptions = enum(objc.NSUInteger) {
    AppleEventSendNoReply = 1,
    AppleEventSendQueueReply = 2,
    AppleEventSendWaitForReply = 3,
    AppleEventSendNeverInteract = 16,
    AppleEventSendCanInteract = 32,
    AppleEventSendAlwaysInteract = 48,
    AppleEventSendCanSwitchLayer = 64,
    AppleEventSendDontRecord = 4096,
    AppleEventSendDontExecute = 8192,
    AppleEventSendDontAnnotate = 65536,
    AppleEventSendDefaultOptions = 35,
};
...
pub const UserNotificationActivationType = enum(objc.NSInteger) {
    UserNotificationActivationTypeNone = 0,
    UserNotificationActivationTypeContentsClicked = 1,
    UserNotificationActivationTypeActionButtonClicked = 2,
    UserNotificationActivationTypeReplied = 3,
    UserNotificationActivationTypeAdditionalActionClicked = 4,
};
