...
pub const Location = opaque {
    ...
    pub fn getDistanceFrom(_self: *@This(), _location: ?*const Location) LocationDistance {
        return objc.msgSend(_self, "getDistanceFrom:", LocationDistance, .{_location});
    }

    pub fn distanceFromLocation(_self: *@This(), _location: ?*const Location) LocationDistance {
...
pub const BeaconRegion = opaque {
    ...
    pub fn peripheralDataWithMeasuredPower(_self: *@This(), _measuredPower: ?*foundation.Number) ?*foundation.MutableDictionary(?*foundation.String, ?objc.Id) {
        return objc.msgSend(_self, "peripheralDataWithMeasuredPower:", ?*foundation.MutableDictionary(?*foundation.String, ?objc.Id), .{_measuredPower});
    }
...
pub const MonitoringEvent = opaque {
    ...
    pub fn refinement(_self: *@This()) ?*Condition {
        return objc.msgSend(_self, "refinement", ?*Condition, .{});
    }
...
pub const MonitoringRecord = opaque {
    ...
    pub fn condition(_self: *@This()) ?*Condition {
        return objc.msgSend(_self, "condition", ?*Condition, .{});
    }
...
pub const Monitor = opaque {
    ...
    pub fn monitoredIdentifiers(_self: *@This()) ?*foundation.Array(?*foundation.String) {
        return objc.msgSend(_self, "monitoredIdentifiers", ?*foundation.Array(?*foundation.String), .{});
    }
};
...
pub const LocationManager = opaque {
    ...
    pub fn requestHistoricalLocationsWithPurposeKeySampleCountCompletionHandler(_self: *@This(), _purposeKey: ?*foundation.String, _sampleCount: objc.NSInteger, _handler: *const fn (?*foundation.Array(?*Location), ?*foundation.Error) callconv(.C) void) void {
    ...
    pub fn monitoredRegions(_self: *@This()) ?*foundation.Set(?*Region) {
        return objc.msgSend(_self, "monitoredRegions", ?*foundation.Set(?*Region), .{});
    }

    pub fn rangedRegions(_self: *@This()) ?*foundation.Set(?*Region) {
        return objc.msgSend(_self, "rangedRegions", ?*foundation.Set(?*Region), .{});
    }

    pub fn rangedBeaconConstraints(_self: *@This()) ?*foundation.Set(?*BeaconIdentityConstraint) {
        return objc.msgSend(_self, "rangedBeaconConstraints", ?*foundation.Set(?*BeaconIdentityConstraint), .{});
    }

    pub fn startMonitoringVisits(_self: *@This()) void {
        return objc.msgSend(_self, "startMonitoringVisits", void, .{});
    }

    pub fn stopMonitoringVisits(_self: *@This()) void {
        return objc.msgSend(_self, "stopMonitoringVisits", void, .{});
    }
};
...
pub const LocationManagerDelegate = opaque {
    ...
    pub fn locationManagerDidUpdateLocations(_self: *@This(), _manager: ?*LocationManager, _locations: ?*foundation.Array(?*Location)) void {
    ...
    pub fn locationManagerDidRangeBeaconsInRegion(_self: *@This(), _manager: ?*LocationManager, _beacons: ?*foundation.Array(?*Beacon), _region: ?*BeaconRegion) void {
    ...
    pub fn locationManagerDidRangeBeaconsSatisfyingConstraint(_self: *@This(), _manager: ?*LocationManager, _beacons: ?*foundation.Array(?*Beacon), _beaconConstraint: ?*BeaconIdentityConstraint) void {
...
pub const Placemark = opaque {
    ...
    pub fn areasOfInterest(_self: *@This()) ?*foundation.Array(?*foundation.String) {
        return objc.msgSend(_self, "areasOfInterest", ?*foundation.Array(?*foundation.String), .{});
    }

    pub fn postalAddress(_self: *@This()) ?*contacts.PostalAddress {
        return objc.msgSend(_self, "postalAddress", ?*contacts.PostalAddress, .{});
    }
};

pub const GeocodeCompletionHandler = *const fn (?*foundation.Array(?*Placemark), ?*foundation.Error) callconv(.C) void;
...
pub const Geocoder = opaque {
    ...
    pub fn geocodePostalAddressCompletionHandler(_self: *@This(), _postalAddress: ?*contacts.PostalAddress, _completionHandler: GeocodeCompletionHandler) void {
        return objc.msgSend(_self, "geocodePostalAddress:completionHandler:", void, .{ _postalAddress, _completionHandler });
    }

    pub fn geocodePostalAddressPreferredLocaleCompletionHandler(_self: *@This(), _postalAddress: ?*contacts.PostalAddress, _locale: ?*foundation.Locale, _completionHandler: GeocodeCompletionHandler) void {
        return objc.msgSend(_self, "geocodePostalAddress:preferredLocale:completionHandler:", void, .{ _postalAddress, _locale, _completionHandler });
    }
};
...
pub const LocationPushServiceExtension = opaque {
    ...
    pub fn didReceiveLocationPushPayloadCompletion(_self: *@This(), _payload: ?*foundation.Dictionary(?*foundation.String, ?objc.Id), _completion: *const fn () callconv(.C) void) void {
