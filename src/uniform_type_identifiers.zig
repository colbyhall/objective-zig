...
pub const Type = opaque {
    ...
    pub fn supertypes(_self: *@This()) ?*anyopaque {
        return objc.msgSend(_self, "supertypes", ?*anyopaque, .{});
    }
    ...
    pub fn typesWithTagTagClassConformingToType(_tag: ?*foundation.String, _tagClass: ?*foundation.String, _supertype: ?*Type) ?*anyopaque {
        return objc.msgSend(Internal.class(), "typesWithTag:tagClass:conformingToType:", ?*anyopaque, .{ _tag, _tagClass, _supertype });
    }
